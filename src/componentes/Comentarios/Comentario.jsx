...
import { likeComentario, comentarioEliminar } from '../../actions/comentarioAction';
...
const Comentario = ({ comentario, blogId }) => {
    ...
    const comentarioCreador = comentario.usuario ? comentario.usuario.nombre_usuario : 'Anónimo'

    // Función para mostrar el botón de eliminar solo al creador del comentario
    const puedeEliminarComentario = comentario.usuario && usuario && comentario.usuario._id === usuario.id
    ...
    return (
        <div className='comentario'>
            ...
            <div>
                <button onClick={() => handleComentarioLike(comentario.id)}> Like </button>
                <div>
                    {puedeEliminarComentario && (
                        <button onClick={() => handleEliminarComentario(comentario.id)}> Eliminar </button>
                    )}
                </div>
            </div>
        </div>
