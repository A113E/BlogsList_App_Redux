import comentarioReducer, { appendComentario, comentarioLike } from './comentariosReducer'
...
describe('comentarioReducer', () => {
  ...
  const action = comentarioLike({
    ...
    comentarioActualizado: { comentario: 'Primer comentario', likes: 1, id: 1 }
  })
  ...
  expect(nuevoEstado.blog123).toContainEqual({ comentario: 'Segundo comentario', likes: 1, id: 2 })

  // el primero se actualizó
  expect(nuevoEstado.blog123).toContainEqual({ comentario: 'Primer comentario', likes: 1, id: 1 })
})
})
